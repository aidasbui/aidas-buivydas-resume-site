...
const Header = () => {
  return (
    <header className="sticky top-0 left-0 z-50 flex h-full flex-col items-center justify-center border-b-2 border-color-purple-700 bg-background-noise bg-cover bg-center py-4 px-12 text-center shadow-xl">
